...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf node-angular-temp && mkdir node-angular-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir starter-node-angular && cp -r node-angular-temp/* starter-node-angular/ && rm -rf node-angular-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `node-angular-temp` folder.');
